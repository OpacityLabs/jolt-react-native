...
public class MyRustModule: Module {
  ...
  public func definition() -> ModuleDefinition {
   ...
   AsyncFunction("jolt_verify") { (proof:String)->Bool in
      return jolt_verify(proof)
    }

    AsyncFunction("jolt_prove") { (a: UInt32) -> String in
      let c_str = jolt_prove(a) as Optional<UnsafePointer<CChar>>
